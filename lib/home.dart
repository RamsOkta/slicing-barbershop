...
class _HomeState extends State<Home> {
  ...
  var selectedBarber = 'Azizi Shafa';
  _selectBarber(name) {
    setState(() {
      selectedBarber = name;
    });
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ListView(
              ...
              children: [
                BarbermanWidget(
                  imgPath: 'assets/zee.jpeg',
                  name: 'Azizi Shafa',
                  tapHandler: _selectBarber,
                  isSelected: selectedBarber == 'Azizi Shafa',
                ),
                const SizedBox(width: 15.0),
                BarbermanWidget(
                  imgPath: 'assets/flora.jpeg',
                  name: 'Flora Shafiqa',
                  tapHandler: _selectBarber,
                  isSelected: selectedBarber == 'Flora Shafiqa',
                ),
                const SizedBox(width: 15.0),
                BarbermanWidget(
                  imgPath: 'assets/indira.jpeg',
                  name: 'Indira Seruni',
                  tapHandler: _selectBarber,
                  isSelected: selectedBarber == 'Indira Seruni',
                ),
                const SizedBox(width: 15.0),
              ],
            ),
